...
{
    public partial class EmailTemplatesCustomerCustomerNewOption : System.Web.UI.Page
    {
        ...
        protected void MessageProperties()
        {
            ...
            ProjectNotification.Text = Resources.Resource.Project + singlespace + project + singlespace;
