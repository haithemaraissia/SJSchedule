<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProfessionalNewOption.aspx.cs" Inherits="EmailTemplates.Professional.InsideWebsite.EmailTemplatesProfessionalInsideWebsiteProfessionalNewOption" %>
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
    <title id="Title1" runat="server" title="<%$ Resources:Resource, Notification %>"></title>
    <style type="text/css">
        .DarkRed
        {
            color: #800000;
