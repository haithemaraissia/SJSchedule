<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CustomerBlocked.aspx.cs"
    Inherits="EmailTemplates.Customer.EmailTemplatesCustomerCustomerBlocked" %>
        ...
        <tr>
            ...
            <td width="80%;" style="background-color: #FFFFFF;">
                ...
                <p>
                    ...
                    <asp:Label ID="AccountLockedMessageLabel" runat="server" Text="<%$ Resources:Resource, AccountLockedMessage%>"></asp:Label>
                </p>
                <p>
