<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProfessionalRefund.aspx.cs" Inherits="EmailTemplatesProfessionalProfessionalRefund" %>
<%@ Register TagPrefix="UpperNavigationButtons" TagName="NavigationButtons" Src="../../common/TemplateMainUpperButtons.ascx" %>
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
    <title id="Title1" runat="server" title="<%$ Resources:Resource, Refund %>"></title>
    <style type="text/css">
        .DarkRed
        {
            color: #800000;
